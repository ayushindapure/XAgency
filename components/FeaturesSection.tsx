...
export default function FeaturesSection() {
    return (
        <section className=" py-16 md:py-32 dark:bg-transparent poppins-regular">
            <div className="mx-auto max-w-5xl px-6">
                <div className="relative">
                    <div className="relative z-10 grid grid-cols-6 gap-3">
                    <Card className="relative col-span-full flex lg:col-span-2 transform-gpu  dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset] ">
                            <CardContent className="relative m-auto size-fit pt-6">
                                
                                <div className="relative mx-auto flex aspect-square size-32 before:absolute before:-inset-2 ">
                                    <Image src="/growth.gif" alt="Fingerprint" width={100} height={100} className="m-auto h-fit w-24" />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                <h2 className="group-hover:text-secondary-950 text-lg font-medium transition poppins-regular dark:text-white ">Proven Results</h2>
                                    <p className=" ">We don’t just design — we deliver <span className='text-blue-400 font-medium'>outcomes</span>. Our clients noticed leads increased by <span className='font-medium text-blue-400'>3x</span></p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden  sm:col-span-3 lg:col-span-2  dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
                            <CardContent className="pt-6">
                                <div className="relative mx-auto flex aspect-square size-32 rounded-full border before:absolute before:-inset-2 before:rounded-full before:border dark:border-white/10 dark:before:border-white/5">
                                    <Image src="/fingerprint.gif" alt="Fingerprint" width={100} height={100} className="m-auto h-fit w-24" />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                    <h2 className="group-hover:text-secondary-950 text-lg font-medium transition poppins-regular dark:text-white">Privacy First</h2>
                                    <p className=""> We ensure every website is <span className='text-green-400'>safe & encrypted</span>, and built with your users’ privacy in mind.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="relative col-span-full overflow-hidden sm:col-span-3 lg:col-span-2  dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
                            <CardContent className="pt-6">
                                ...
                                <Image src="/meetings.gif" alt="Fingerprint" width={100} height={100} className="m-auto h-fit w-24" />
                                </div>
                                <div className="relative z-10 mt-6 space-y-2 text-center">
                                <h2 className="group-hover:text-secondary-950 text-lg poppins-regular transition  dark:text-white">Clear Communication</h2>
                                    <p className="">Provident fugit vero voluptate. magnam magni doloribus dolores voluptates inventore nisi.</p>
                                </div>
                            </CardContent>
                        </Card>
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3  dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
                            <CardContent className="grid pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition poppins-regular dark:text-white">Clear Communication</h2>
                                        <p className="">We keep keeping everything transparent, from timelines and pricing to progress updates. You're never left guessing </p>
                                    </div>
                                </div>
                        ...
                        <Card className="card variant-outlined relative col-span-full overflow-hidden lg:col-span-3  dark:bg-background dark:[border:1px_solid_rgba(255,255,255,.1)] dark:[box-shadow:0_-20px_80px_-20px_#ffffff1f_inset]">
                            <CardContent className="grid h-full pt-6 sm:grid-cols-2">
                                <div className="relative z-10 flex flex-col justify-between space-y-12 lg:space-y-6">
                                    ...
                                    <div className="space-y-2">
                                        <h2 className="group-hover:text-secondary-950 text-lg font-medium text-zinc-800 transition poppins-regular dark:text-white">Small Team, Big Impact</h2>
                                        <p className="">We’re a passionate team of 4 — designers, developers, and strategists. We treat every brand like it’s our own.</p>
                                    </div>
                                </div>
                                <div className="before:bg-(--color-border) relative mt-6 before:absolute before:inset-0 before:mx-auto before:w-px sm:-my-6 sm:-mr-6">
                                    <div className="relative flex h-full flex-col justify-center space-y-6 py-6">
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Gaurav</span>
                                        ...
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            ...
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Joseph</span>
                                        </div>
                                        <div className="relative flex w-[calc(50%+0.875rem)] items-center justify-end gap-2">
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Parth</span>
                                            <div className="ring-background size-7 ">
                                        ...
                                        <div className="relative ml-[calc(50%-1rem)] flex items-center gap-2">
                                            <div className="ring-background size-8 ">
                                                <img className="size-full rounded-full" src="http://localhost:3000/ayush.JPG" alt="" />
                                            </div>
                                            <span className="block h-fit rounded border px-2 py-1 text-xs shadow-sm">Ayush</span>
                                        </div>
                                    </div>
                                </div>
                            </CardContent>
