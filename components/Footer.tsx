...
const Footer = () => {
  ...
  return (
    <>
      ...
      <div
        className='relative h-full sm:pt-14 pt-8 bg-[#f7f7f7] text-black dark:text-white dark:bg-[#121212]'
        ref={container}
      >
        <div className='sm:container  px-4 mx-auto'>
          <div className='md:flex justify-between w-full'>
            ...
            <div className='flex gap-10 text-gray-400'>
              <ul>
                <li className='text-2xl pb-2 text-black dark:text-white font-semibold'>
                  SITEMAP
                </li>
          ...
          <div className='flex md:flex-row flex-col-reverse gap-3 justify-between py-2'>
            <span className='font-medium'>
              &copy; 2025 X Agency. All Rights Reserved.
            </span>
