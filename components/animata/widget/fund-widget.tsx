...
export default function FundWidget({
  ...
  return (
    <>
      <div
        className={cn(
          "storybook-fix group flex items-center justify-center ",
          containerClassName,
        )}
      >
        <div
        ...
        <AnimatePresence initial={false}>
          <div className="flex h-24 w-10 flex-col items-center">
            ...
            <div className="z-10 -mt-8 h-10 w-[30px] rounded-b-[35px] bg-white shadow-[0px_0px_5px_1px_#bec2bf]"></div>
          </div>
        </AnimatePresence>
      </div>
    </>
